...
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
  ...
  "javascript": [
    ...
    "data:text/javascript,document.addEventListener(''DOMContentLoaded'',function(){document.title=''Fleetfolio'';});"
  ],
...
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
      ...
      'SELECT case when sqlpage.environment_variable(''EOH_INSTANCE'')=1 then ''shell-custom'' else ''shell'' END AS component,
       ...
       ''data:text/javascript,document.addEventListener(''''DOMContentLoaded'''',function(){document.title=''''Fleetfolio'''';});'' AS javascript,
       json_object(
