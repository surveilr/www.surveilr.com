-- code provenance: `TypicalSqlPageNotebook.commonDDL` (file:///home/ditty/workspaces/github.com/dittybijil/www.surveilr.com/lib/std/notebook/sqlpage.ts)
...
SELECT 
    ...
    (SELECT status from test_case_run_results where test_case_id=tc.test_case_id) as test_status
FROM 
    groups g
JOIN 
    test_cases tc
...
-- code provenance: `ConsoleSqlPages.infoSchemaDDL` (file:///home/ditty/workspaces/github.com/dittybijil/www.surveilr.com/lib/std/web-ui-content/console.ts)
...
INSERT OR REPLACE INTO code_notebook_cell (notebook_kernel_id, code_notebook_cell_id, notebook_name, cell_name, interpretable_code, interpretable_code_hash, description) VALUES (
  ...
  '      -- code provenance: `ConsoleSqlPages.infoSchemaContentDML` (file:///home/ditty/workspaces/github.com/dittybijil/www.surveilr.com/lib/std/web-ui-content/console.ts)
...
-- code provenance: `ConsoleSqlPages.console/content/action/regenerate-auto.sql` (file:///home/ditty/workspaces/github.com/dittybijil/www.surveilr.com/lib/std/web-ui-content/console.ts)
...
INSERT INTO sqlpage_files (path, contents, last_modified) VALUES (
      ...
      'SELECT ''shell'' AS component,
       ...
       ''Surveilr (1.5.10)  Resource Surveillance Web UI (v'' || sqlpage.version() || '') '' || ''📄 ['' || substr(sqlpage.path(), 2) || '']('' || sqlpage.environment_variable(''SQLPAGE_SITE_PREFIX'') || ''/console/sqlpage-files/sqlpage-file.sql?path='' || substr(sqlpage.path(),LENGTH(sqlpage.environment_variable(''SQLPAGE_SITE_PREFIX'')) + 2 ) || '')'' as footer;',
      CURRENT_TIMESTAMP)
  ON CONFLICT(path) DO UPDATE SET contents = EXCLUDED.contents, last_modified = CURRENT_TIMESTAMP;
