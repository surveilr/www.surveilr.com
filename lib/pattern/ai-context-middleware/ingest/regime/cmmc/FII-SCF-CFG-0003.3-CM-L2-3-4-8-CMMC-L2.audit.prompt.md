---
title: "Audit Prompt: Application Control Policy for Security Compliance"
weight: 1
...
- **Control's Stated Purpose/Intent:** "The organization explicitly allows (allowlist / whitelist) and/or blocks (denylist / blacklist) applications that are authorized to execute on systems."
  - **Control Code:** CM.L2-3.4.8
  - **Control Question:** Does the organization explicitly allow (allowlist / whitelist) and/or block (denylist / blacklist) applications that are authorized to execute on systems?
  - **Internal ID (Foreign Integration Identifier as FII):** FII-SCF-CFG-0003.3
- **Policy/Process Description (for context on intent and expected evidence):** 
  "This policy outlines the framework for managing authorized applications within the organization to ensure the integrity, confidentiality, and availability of information systems. Effective application control is vital in mitigating risks associated with unauthorized applications, which can lead to security breaches and data loss. This policy establishes guidelines for allowlisting and denylisting applications to maintain a secure operational environment. The organization mandates a comprehensive application control strategy that encompasses both allowlisting of approved applications and denylisting of unauthorized applications. All systems must only execute applications that have been explicitly allowed, while all others will be blocked to ensure compliance with security protocols."
- **Provided Evidence for Audit:** 
  "Automated logs from security tools must be generated and reviewed to verify compliance with application control policies. Utilize automated scripts to generate reports on application execution and compare them against the allowlist and denylist. Employees must document findings of unauthorized applications using standardized forms, which will be submitted to the IT Security Team for processing."

**Requirements for Your Audit Report  (Structured format):**

# Official Audit Report: CMMC - CM.L2-3.4.8
...
**Control Code:** CM.L2-3.4.8
**Control Question:** Does the organization explicitly allow (allowlist / whitelist) and/or block (denylist / blacklist) applications that are authorized to execute on systems?
**Internal ID (FII):** FII-SCF-CFG-0003.3
**Control's Stated Purpose/Intent:** The organization explicitly allows (allowlist / whitelist) and/or blocks (denylist / blacklist) applications that are authorized to execute on systems.
...
* **Control Requirement/Expected Evidence:** Automated logs from security tools must be generated and reviewed to verify compliance with application control policies.
...
* **Control Requirement/Expected Evidence:** Utilize automated scripts to generate reports on application execution and compare them against the allowlist and denylist.
    * ... (Repeat for all machine-attestable aspects, providing granular assessment for each)

### 2.2 Human Attestation Evidence Assessment

* **Control Requirement/Expected Evidence:** Employees must document findings of unauthorized applications using standardized forms, which will be submitted to the IT Security Team for processing.
