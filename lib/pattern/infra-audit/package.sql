...
regulatory requirements.'),
    ('prime', '/opsfolio', 3, '/opsfolio/infra/audit/control_regime.sql', '/opsfolio/infra/audit/control_regime.sql', 'Control Regimes', NULL, NULL, NULL),
    ('prime', '/opsfolio', 1, '/opsfolio/infra/audit/session_list.sql', '/opsfolio/infra/audit/session_list.sql', 'Audit Sessions', NULL, NULL, NULL),
    ('prime', '/opsfolio', 1, '/opsfolio/infra/audit/session_detail.sql', '/opsfolio/infra/audit/session_detail.sql', 'Audit Sessions', NULL, NULL, NULL),
    ('prime', '/opsfolio', 1, '/opsfolio/infra/audit/control_detail.sql', '/opsfolio/infra/audit/control_detail.sql', 'Controls Detail', NULL, NULL, NULL)
ON CONFLICT (namespace, parent_path, path)
DO UPDATE SET title = EXCLUDED.title, abbreviated_caption = EXCLUDED.abbreviated_caption, description = EXCLUDED.description, url = EXCLUDED.url, sibling_order = EXCLUDED.sibling_order;
