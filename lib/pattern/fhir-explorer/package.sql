...
INSERT INTO sqlpage_aide_navigation (namespace, parent_path, sibling_order, path, url, caption, abbreviated_caption, title, description)
VALUES
    ('prime', '/', 1, '/fhir', '/fhir/', 'FHIR Examples', NULL, NULL, 'Learn how to query injested FHIR content using SQL'),
    ('prime', '/fhir', 1, '/fhir/info-schema.sql', '/fhir/info-schema.sql', 'FHIR-specific Tables and Views', NULL, NULL, 'Information Schema documentation for FHIR-specific database objects'),
    ('prime', '/fhir', 2, '/fhir/uniform-resource-summary.sql', '/fhir/uniform-resource-summary.sql', 'Uniform Resources Summary', NULL, NULL, 'uniform_resource row statistics (may be slow, be patient after clicking)'),
    ('prime', '/fhir', 3, '/fhir/bundles-summary.sql', '/fhir/bundles-summary.sql', 'FHIR Bundles Summary', NULL, NULL, 'count of types of FHIR resources available across all bundles (may be slow, be patient after clicking)'),
    ('prime', '/fhir', 10, '/fhir/patients.sql', '/fhir/patients.sql', 'Patient Resources', NULL, NULL, 'Patient resources found in FHIR bundles (may be slow, be patient after clicking)'),
    ('prime', '/fhir', 10, '/fhir/observations.sql', '/fhir/observations.sql', 'Observation Resources', NULL, NULL, 'Observation resources found in FHIR bundles (may be slow, be patient after clicking)')
ON CONFLICT (namespace, parent_path, path)
DO UPDATE SET title = EXCLUDED.title, abbreviated_caption = EXCLUDED.abbreviated_caption, description = EXCLUDED.description, url = EXCLUDED.url, sibling_order = EXCLUDED.sibling_order;
