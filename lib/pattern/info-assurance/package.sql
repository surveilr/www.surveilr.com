...
FROM breadcrumbs ORDER BY level DESC;
              ...
              SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/threat_model_analysis_report.sql/index.sql'') as contents;
    ;
...
SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/web_application.sql/index.sql'') as contents;
    ;
SELECT ''list'' as component
SELECT
 Title as title
...
FROM breadcrumbs ORDER BY level DESC;
              ...
              SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/managed_application.sql/index.sql'') as contents;
    ;
...
SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/sql_database.sql/index.sql'') as contents;
    ;
SELECT ''list'' AS component
SELECT
 Title as title
...
SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/boundaries.sql/index.sql'') as contents;
    ;
SELECT ''list'' AS component
SELECT
 boundary as title
...
FROM breadcrumbs ORDER BY level DESC;
              ...
              SELECT ''title'' AS component, (SELECT COALESCE(title, caption)
    FROM sqlpage_aide_navigation
   WHERE namespace = ''prime'' AND path = ''opsfolio/info/assurance/threat_model/threat_model_analysis_report/detail.sql/index.sql'') as contents;
    ;
