export const testcaseDetails: any = [
  {
    ...
    result:
      "The page at https://eg.surveilr.com/ should load successfully without errors.",
    tags: "Home page",
  ...
  },
  {
    ...
    description:
      "Ensure that the RSSD logo is visible on the top left of the site.",
    result:
      "The RSSD logo should be clearly visible on the top left corner of the site.",
    tags: "Home page",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Ensure that the text 'Resource Surveillance State Database (RSSD)' is visible at the top of the homepage.",
    result:
      "The text 'Resource Surveillance State Database (RSSD)' should be clearly visible at the top of the homepage.",
    tags: "Home page",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Ensure that all the following tabs are visible on the top of the homepage: Home, Docs, Uniform Resource, Console, Orchestration.",
    result:
      "All the tabs (Home, Docs, Uniform Resource, Console, Orchestration) should be visible on the top of the homepage.",
    tags: "Home page",
    test_type: ["smoke-high"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Ensure that the Uniform Resource dropdown shows the following options correctly: Uniform Resources (IMAP), Uniform Resources (Files), Uniform Resource Tables and Views.",
    result:
      "The dropdown should display the options: Uniform Resources (IMAP), Uniform Resources (Files), Uniform Resource Tables and Views.",
    tags: "Home page",
    test_type: ["smoke-high"],
  },
  {
    ...
    description:
      "Ensure that navigation for Uniform Resource (IMAP) works properly.",
  ...
  },
  {
    ...
    description:
      "Ensure that navigation for Uniform Resource (File) works properly.",
  ...
  },
  {
    ...
    description:
      "Ensure that navigation for Uniform Resource Tables & Views works properly.",
    result:
      "The user should be navigated to the Uniform Resource Tables & Views page.",
    tags: "Home page",
    test_type: ["smoke-high", "smoke-low", "regression-high"],
  },
  {
    ...
    result:
      "The dropdown should display the correct options as per the requirement.",
    tags: "Home page",
    test_type: ["smoke-high", "smoke-low", "regression-high"],
  },
  {
    ...
    description:
      "Verify that the 'RSSD SQLPage Files' tab link navigation works properly.",
    result:
      "The user should be navigated to the correct page when clicking the 'RSSD SQLPage Files' tab link.",
    tags: "Home page",
    test_type: ["smoke-high", "smoke-low", "regression-high"],
  },
  {
    ...
    description:
      "Verify that the navigation of the links provided in the footer of the RSSD SQL Page Files is correct.",
  ...
  },
  {
    ...
    description:
      "Verify that the 'RSSD Data Tables Content SQLPage Files' tab link navigation works properly.",
    result:
      "The user should be navigated to the correct page when clicking the 'RSSD Data Tables Content SQLPage Files' tab link.",
    tags: "Home page",
    test_type: ["smoke-high"],
  },
  {
    ...
    description:
      "Verify that the navigation of the links provided in the footer of the RSSD Data Tables Content SQLPage Files page is correct.",
    result: "The footer links should navigate to the correct pages.",
    tags: "Home page",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Verify that the 'RSSD SQLPage Navigation' tab link navigation works properly.",
    result:
      "The user should be navigated to the correct page when clicking the 'RSSD SQLPage Navigation' tab link.",
    tags: "Home page",
    test_type: ["smoke-high"],
  },
  {
...

  {
    ...
    result:
      "The 'Site Quality Explorer' logo and header should be clearly visible at the top of the page.",
  ...
  },
  {
    ...
    description:
      "Verify there are 4 controls loaded on the page: 1. Orchestration, 2. Site Quality, 3. Uniform Resource, 4. RSSD Console.",
    result:
      "All 4 controls (Orchestration, Site Quality, Uniform Resource, RSSD Console) should be visible and loaded properly.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Verify that the navigation of the Website Resources - 'eg.surveilr.com' is proper.",
    result:
      "The 'eg.surveilr.com' site navigation should work correctly and navigate to the expected pages.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Verify that the navigation of the Website Resources - 'surveilr.com' is proper.",
    result:
      "The 'surveilr.com' site navigation should work correctly and navigate to the expected pages.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  {
  ...
  },
  {
    ...
    description:
      "Verify that footer links on the Orchestration page navigate properly.",
    result:
      "All footer links on the Orchestration page should navigate to the correct destinations.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Verify that footer links on the Uniform Resource (IMAP) page navigate properly.",
    result:
      "All footer links on the Uniform Resource (IMAP) page should navigate to the correct destinations.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  {
    ...
    description:
      "Verify that footer links on the RSSD Console page navigate properly.",
    result:
      "All footer links on the RSSD Console page should navigate to the correct destinations.",
    tags: "Site Quality Explorer",
    test_type: ["smoke-low"],
  },
  // compliance explorer
  {
    ...
    description:
      "Verify that the Compliance Explorer logo is visible on the top left of the Direct Messaging Service page.",
    result:
      "The Compliance Explorer logo should be clearly visible on the top left of the Direct Messaging Service page.",
  ...
  },
  {
    ...
    description:
      "Verify there are 4 controls loaded on the page: 1. SCF Controls, 2. Orchestration, 3. Uniform Resource, 4. RSSD Console.",
    result:
      "All 4 controls (SCF Controls, Orchestration, Uniform Resource, RSSD Console) should be visible and loaded properly.",
    tags: "Compliance Explorer",
    test_type: ["smoke-high"],
  },
  {
    ...
    result:
      "The SCF Controls menu should navigate to the correct pages without errors.",
    tags: "Compliance Explorer",
    test_type: ["smoke-high"],
  },
  {
    ...
    result:
      "The breadcrumbs on the SCF Control page should navigate to the correct pages.",
    tags: "Compliance Explorer",
    test_type: ["smoke-high"],
  },
  {
    ...
    description:
      "Verify that the navigation of the links provided in the footer of the SCF Control page is correct.",
    result:
      "All footer links on the SCF Control page should navigate to the correct destinations.",
    tags: "Compliance Explorer",
    test_type: ["smoke-low"],
  },

  {
    ...
    result:
      "US HIPAA block displayed with correct details including geography, source, act, and published date.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0007",
    ...
    result:
      "NIST block displayed with correct geography, source, act, version, and published date.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0008",
    ...
    result:
      "US HIPAA Detail View Links navigate correctly, and title 'US HIPAA Controls' is visible.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0009",
  ...
  },
  {
    ...
    result:
      "Table titles (control code, title, domain, description, requirement) are displayed correctly.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0011",
    ...
    result:
      "Sorting functionality works as expected for control code, title, domain, description, and requirement.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0012",
  ...
  },
  {
    ...
    result:
      "Each control detail page includes all expected information (question, description, ID, domain, SCF Control).",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0014",
    ...
    result:
      "NIST Detail View Links navigate correctly, and title 'NIST Controls' is visible.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0015",
    ...
    result:
      "Expected Result: Search bar should filter results as per the entered query.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0016",
    ...
    result:
      "Expected Result: All specified columns should display accurate data.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0017",
    ...
    result:
      "Expected Result: Sorting should work correctly for all specified columns.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0018",
    ...
    result:
      "Expected Result: Clicking on control codes should navigate to corresponding detail pages.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-CEP-0019",
    ...
    result:
      "Expected Result: All specified details should be present on each control detail page.",
    test_type: ["smoke-high"],
  },
  // Direct messaging service
  {
    ...
    result:
      "Expected Result: All 4 controls should be visible and properly loaded on the page.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0003",
    ...
    result:
      "Expected Result: Navigation to 'Direct Protocol Email System' tab should work as intended.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0004",
    ...
    result:
      "Expected Result: Inbox, Dispatched, and Failed controls should be displayed on the dashboard.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0005",
    ...
    result:
      "Expected Result: Footer links should navigate to correct destinations.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0006",
  ...
  },
  {
    ...
    tags: ["Direct Messaging Services", "Direct Protocol Email System"],
    description:
      "Verify that the all 'SUBJECT' column data in Inbox page navigation is proper",
    result:
      "Expected Result: All SUBJECT column data links should navigate to corresponding pages.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0009",
    ...
    tags: ["Direct Messaging Services", "Direct Protocol Email System"],
    description:
      "Verify that the navigation of attachments files in the Subject data link page is proper",
  ...
  },
  {
    ...
    result:
      "Expected Result: Dispatched menu navigation should work correctly.",
    test_type: ["smoke-high"],
  },
  {
    id: "TC-DMS-0014",
  ...
  },
  {
    ...
    tags: ["Direct Messaging Services", "Direct Protocol Email System"],
    description:
      "Verify that the breadcrumbs on the Failed page navigate correctly.",
    result:
      "Expected Result: Breadcrumbs should navigate to the correct pages.",
    test_type: ["smoke-high"],
  },
];
