class SQESelectors {
  ...
  public static sqeFooterlinkNavTextSel1 =
    "//h1[normalize-space(text())='sq/index.sql']";
  public static sqeFooterlinkNavTextSel2 =
    "//h1[normalize-space(text())='console/sqlpage-files/sqlpage-file.sql']";
  public static uniResourceFootNavTextSel1 =
    "//h1[normalize-space(text())='ur/index.sql']";
  public static uniResourceFootNavTextSel2 =
    "//h1[normalize-space(text())='console/sqlpage-files/sqlpage-file.sql']";
  public static RSSDConsoleFootNavTextSel1 =
    "//main[@id='sqlpage_main_wrapper']//h1[1]";
  public static RSSDConsoleFootNavTextSel2 =
    "//h1[normalize-space(text())='console/sqlpage-files/sqlpage-file.sql']";
  public static OrchestrationFootNavTextSel1 =
    "//h1[normalize-space(text())='orchestration/index.sql']";
  public static OrchestrationFootNavTextSel2 =
    "//h1[normalize-space(text())='console/sqlpage-files/sqlpage-file.sql']";
  // Input variable
